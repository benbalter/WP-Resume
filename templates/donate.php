...
<tr valign="top" id="donate">
	...
	<td>
		<em><?php echo sprintf( __( 'Enjoy using %1$s? Please consider <a href="%2$s">making a small donation</a> to support the software\'s continued development.', 'wp-resume' ), $this->parent->name, $this->parent->donate->link ); ?></em>
